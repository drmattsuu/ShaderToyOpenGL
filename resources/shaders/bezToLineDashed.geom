...
void drawLine(vec2 points[2], vec4 colors[2], float zValues[2])
{
    ...
    VertexOut.fStartPos = VertexIn[0].startPos;
    VertexOut.fVertPos = VertexIn[0].vertPos;
    ...
    VertexOut.fStartPos = VertexIn[3].startPos;
    VertexOut.fVertPos = VertexIn[3].vertPos;
